 ...
 */
public class ZapisDoSouboru2 extends Thread{
    ...
    public ZapisDoSouboru2(ArrayList<SensorValue>  values, String idMereni, String typMereni, String sourceDir, Handler serviceHandler){
