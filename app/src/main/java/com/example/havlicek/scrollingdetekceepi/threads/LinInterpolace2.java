 ...
 */
public class LinInterpolace2 extends Thread{
    private Handler serviceHandler;
    private ArrayList<SensorValue> values;

    public LinInterpolace2(ArrayList<SensorValue> values, Handler serviceHandler){
    ...
    public void run(){
        ...
        Message msg = serviceHandler.obtainMessage(ServiceDetekce.HandlerService.LIN_INTER_FINISHED, values);
